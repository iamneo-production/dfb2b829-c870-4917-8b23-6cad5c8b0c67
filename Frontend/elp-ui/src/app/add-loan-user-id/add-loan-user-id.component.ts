...
@Component({
  selector: 'app-add-loan-user-id',
  templateUrl: './add-loan-user-id.component.html',
  styleUrls: ['./add-loan-user-id.component.css']
})
export class AddLoanUserIdComponent  implements AfterViewInit {
  loan: Loan = {
    loanAmount: 0,
    startDate: new Date(),
    endDate: new Date(),
